...
class MyAuthentificationAuthenticator extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('ad.refrentiel.liste'));
